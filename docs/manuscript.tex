...
% FIXME: training trials ended after 10 seconds
...
A version of the dissimilarity-similarity generalised context model \citeA<DGCM, >{stewart2007dissimilarity} modified by \citeA{o2018model} has been proposed as an explanation of the IBRE.
...
% TODO: mention that ELMO can't do the shared cue effect
...
% TODO: introduce guess-and-correct before the conclusion
...
GitHub links will be inserted when document is deanonymized.

\section{Acknowledgement}

The data for Experiment 1 was collected as part of a final-year undergraduate project. We thank for the help and contributions of [to be added on deanonymization of paper].
