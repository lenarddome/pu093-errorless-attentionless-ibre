...
In this study, we gradually removed elements of a predictive learning design.
...
In our second study, we further removed any causal relationship between stimulus features and category labels.
...
We propose that any theories and models of the inverse base-rate effect must be designed in a way that allows information encoding and connection updates to proceed without prediction error.
