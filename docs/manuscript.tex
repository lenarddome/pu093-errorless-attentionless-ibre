...
In this study, we gradually detached elements of a predictive learning design to test the extent to which error-driven processes underly this bias.
...
% LD: if I talk about supervised/predictive learning at the end, I should probably include something here
...
Their design involved disjoint cues (where categories shared no features in common), while the canonical design depends on a shared feature during training \cite{kruschke2001inverse, wills2014attention}.
...
In this experiment, we implemented the IBRE in a way most similar to unsupervised category learning paradigms.
...
To further investigate this, the unsupervised IBRE procedure could incorporate eye-tracking to measure dwell time and order of information encoding.
