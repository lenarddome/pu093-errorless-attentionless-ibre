...
In their design, common category exemplars were made up of two features, while rare exemplars only had a single feature.
...
One can hypothesise that a shared cue is only a sufficient condition.
...
Compared to \citeA{johansen2007paradoxical}, we do not consider asymmetric representation and base-rate neglect as necessary conditions.
From our point of view, they result from the experimental conditions, which was our focus here.
