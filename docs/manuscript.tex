...
Participants showed a clear common preference for stimuli A, $M = 0.74$, 95\% HDI $[0.66, 0.82]$, $\mathrm{BF}_{10} = 61,428.74$.
...
Participants also showed a reliable rare preference on ambiguous BC trials, $M = 0.68$, 95\% HDI $[0.60, 0.77]$, $\mathrm{BF}_{10} = 412.77$.
This gives us a sufficient amount of evidence to conclude that we have observed the IBRE.
